...
# Form implementation generated from reading ui file 'ISFP1.ui'
#
# Created: Mon Jun 15 11:38:43 2015
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.label_2.setPixmap(QtGui.QPixmap(_fromUtf8("Base Picture/ISFP/ciri.jpg")))
        ...
        self.label_3.setPixmap(QtGui.QPixmap(_fromUtf8("Base Picture/ISFP/kerja.jpg")))
        ...
        self.label_4.setPixmap(QtGui.QPixmap(_fromUtf8("Base Picture/ISFP/tokoh.jpg")))
        ...
        self.label_5.setPixmap(QtGui.QPixmap(_fromUtf8("Base Picture/ISFP/pengembangan.jpg")))
        ...
        self.label_6.setPixmap(QtGui.QPixmap(_fromUtf8("Base Picture/ISFP/dekrip.jpg")))
        self.label_6.setObjectName(_fromUtf8("label_6"))
        self.tabWidget.addTab(self.tab_4, _fromUtf8(""))
        self.label = QtGui.QLabel(Dialog)
        self.label.setGeometry(QtCore.QRect(-10, -30, 1291, 640))
        self.label.setText(_fromUtf8(""))
        self.label.setPixmap(QtGui.QPixmap(_fromUtf8("Base Picture/ISFP/base.jpg")))
    ...
    def retranslateUi(self, Dialog):
        Dialog.setWindowTitle(_translate("Dialog", "Kepribadian ISFP", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.widget), _translate("Dialog", "Ciri - Ciri ISFP", None))
