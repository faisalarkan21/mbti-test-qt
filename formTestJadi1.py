...
from formtest2 import  Ui_MainWindow
from Tkinter import *
        ...
        class formTest(QtGui.QMainWindow):
    ...
    def jumTotal(self):
        ...
        if ((self.ui.radioButtonP1.isChecked() or self.ui.radioButtonJ1.isChecked()) and
            ...
            QMessageBox.information(self, "Pehatihan", "Silahkan tekan tombol Lihat hasil","Oke")
          ...
          QMessageBox.information(self, "Pehatihan", "Tolong isi semua pilihan Terlebih dahulu","Oke")
    ...
    def kalkulasi (self):
        ...
        QMessageBox.information(self, "Pehatihan", "Selamat anda adalah seorang %s%s%s%s" % (self.IorE,self.SorI,self.TorF,self.PorJ),"Terima kasih :)")


        self.close()

        if ((self.IorE == "I") and (self.SorI=="N") and (self.TorF=="T") and (self.PorJ=="P")):
            from INTP import Ui_Dialog
