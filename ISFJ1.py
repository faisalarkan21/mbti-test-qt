...
# Form implementation generated from reading ui file 'ISFJ1.ui'
#
# Created: Mon Jun 15 11:37:49 2015
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.label_2.setPixmap(QtGui.QPixmap(_fromUtf8("Base Picture/ISFJ/ciri.jpg")))
        ...
        self.label_3.setPixmap(QtGui.QPixmap(_fromUtf8("Base Picture/ISFJ/kerja1.jpg")))
        ...
        self.label_4.setPixmap(QtGui.QPixmap(_fromUtf8("Base Picture/ISFJ/tokoh.jpg")))
        ...
        self.label_5.setPixmap(QtGui.QPixmap(_fromUtf8("Base Picture/ISFJ/pengembangan.jpg")))
        ...
        self.label_6.setPixmap(QtGui.QPixmap(_fromUtf8("Base Picture/ISFJ/depkrip.jpg")))
        self.label_6.setObjectName(_fromUtf8("label_6"))
        self.tabWidget.addTab(self.tab_4, _fromUtf8(""))
        self.label = QtGui.QLabel(Dialog)
        self.label.setGeometry(QtCore.QRect(-10, -30, 1291, 640))
        self.label.setText(_fromUtf8(""))
        self.label.setPixmap(QtGui.QPixmap(_fromUtf8("Base Picture/ISFJ/base.jpg")))
    ...
    def retranslateUi(self, Dialog):
        Dialog.setWindowTitle(_translate("Dialog", "Kepribadian ISFJ", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.widget), _translate("Dialog", "Ciri - Ciri ISFJ", None))
